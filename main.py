...
if __name__ == '__main__':
    ...
    parser.add_argument('--proposal',   type=str,   default='mix',  help='how to pose proposals')
    parser.add_argument('--rand_ratio', type=float, default=.1,     help='random ratio in mix proposal')
    parser.add_argument('--objectives', type=str,   default='gsk3b,jnk3,qed,sa,div')
    parser.add_argument('--score_wght', type=str,   default='  1.0, 1.0, 1.0, 1.0, 0.3')
    parser.add_argument('--score_succ', type=str,   default='  0.5, 0.5, 0.6, .67,  -1')
    parser.add_argument('--score_clip', type=str,   default='  0.6, 0.6, 0.7, 0.7,  -1')
